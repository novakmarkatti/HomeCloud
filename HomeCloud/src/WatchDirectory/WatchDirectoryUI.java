...
public class WatchDirectoryUI {

    private Parent root;
    private double xOffset, yOffset;
    public static String SERVER_IP;

    /* A Watch a directory ablak betolteseert felel. Parameterkent egy ip-cimet kap,
    ...
    public void display(String IP) throws Exception {
        ...
        FXMLLoader loader = new FXMLLoader( getClass().getResource( "/WatchDirectory/WatchDirectory.fxml" ) );
        root = loader.load();
